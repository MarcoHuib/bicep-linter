...
export function activate(context: vscode.ExtensionContext): void {
  ...
  function checkSectionOrder(order: number, currentOrder: number, token: string, line: number, diagList: vscode.Diagnostic[]): void {
  ...
  function checkPrefix(keyword: string, name: string, textLine: string, line: number, diagList: vscode.Diagnostic[]): void {
  ...
  function checkTypeConstraint(tokens: string[], name: string, textLine: string, line: number, diagList: vscode.Diagnostic[]): void {
